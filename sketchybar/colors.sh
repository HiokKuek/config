...
# -- Teal Scheme --
export BAR_COLOR=0xff1a1a1a        # deep matte gray for the bar background
export ITEM_BG_COLOR=0xff2e2e2e    # slightly lighter gray for item backgrounds
export ACCENT_COLOR=0xffc0c0c0
export POPUP_BG_COLOR=0xff1a1a1a
export POPUP_ACTIVE_BG_COLOR=0xff2e2e2e
